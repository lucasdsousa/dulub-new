...
<img src="images/BANNER - CATÁLOGOS.png" id="banner_web" style="width:100%" alt="">
<img src="images/mobile/Banner Site Catálogos.png" id="banner_mob" style="width:100%" alt="">
...
<div class="container">
    <h1 class="text-center mb-4" style="color:red; font-size:48px"><strong>Catálogos</strong></h1>
    <h5 style="text-align: center; color:#A9ABAE">Baixe os nossos catálogos e conheça toda nossa linha de produtos.</h5>
</div>

<div class="container mt-5 mb-5" id="web">
...
<div class="container mt-5 mb-5" id="mobile">
    <div class="row align-items-center mb-5" style="align-items: center;">
        <div class="col">
            <img src="images/CAT 01.png" style="width:100%" alt="">
            <a class="btn text-white d-block mt-4" href="docs/Catálogo Dulub - Veículos Leves.pdf" style="background-color:red; margin:0 auto; width:75%; border-radius:0 !important" download>Download</a>
        </div>
