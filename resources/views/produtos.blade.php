...
<nav class="navbar navbar-expand-lg shadow fixed-top" id="navbar" style="background-color: black">
    <div class="container" style="margin-left:5rem; height:4rem">
      ...
      <div class="collapse navbar-collapse" id="navbar-content" style="margin-left:25px">
        ...
        <img src="images/Banner - Produtos.png" id="banner_web" style="width:100%" alt="">
        ...
        <div class="d-grid gap-2 col-9 mx-auto mb-5" id="web">
                @foreach($categorias as $c)
                    <button class="btn" id="categorias" style="text-align:left; border-radius:0 !important;" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_{{ $c->id }}" aria-expanded="false" aria-controls="collapse_{{ $c->id }}">
                        {{ $c->nomeCategoria }}
                    </button>
                    <div class="collapse mb-3" id="collapse_{{ $c->id }}">
        ...
        <img class="mb-5 d-block mx-auto" id="powered" src="images/POWERED BY DULUB.png" alt="">
