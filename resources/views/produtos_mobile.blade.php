...
<nav class="navbar navbar-expand-lg shadow fixed-top" id="navbar" style="background-color: black">
    <div class="container" style="margin-left:5rem; height:4rem">
      ...
      <div class="collapse navbar-collapse container-fluid" id="navbar-content" style="margin-left:25px; background-color:black">
        ...
        <img src="images/mobile/Banner Página.png" id="banner_mob" style="width:100%" alt="">
                            ...
                            <div class="card card-body mb-4" style="background-color: #F6F9FC; border-radius:0 !important;">
                                    <div style="background-color: #F6F9FC;">
                                        ...
                                        <div class="mt-5" style="align-items: center; justify-content: center;">
                                            ...
                                            <img class="d-flex w-100 mx-auto mt-5" src="{{ asset($p->tamanhos) }}" alt="">
                                            <div class="container-fluid mx-auto" style="algin-items: center; justify-content: center;">
                                                <a class="d-flex btn mx-auto mt-5" href="{{ asset($p->ficha) }}" download style="color:white; background-color:#333333; border-radius:0 !important">Ver Ficha Técnica<i class="fa-light fa-list-tree"></i></a>
                                                <a class="d-flex btn mx-auto mt-3" href="{{ asset($p->fispq) }}" download style="color:white; background-color:red; border-radius:0 !important">BAIXAR FISPQ</a>
                                            </div> 
                                        </div>
                                    </div>
                        </div>
